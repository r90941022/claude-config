...
export PATH=/localhome/local-hjc/.npm-global/bin\:/localhome/local-hjc/.npm-global/bin\:/localhome/local-hjc/.vscode-server/cli/servers/Stable-6f17636121051a53c88d3e605c491d22af2ba755/server/bin/remote-cli\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
