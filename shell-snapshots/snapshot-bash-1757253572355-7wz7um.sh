...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/localhome/local-hjc/.npm-global/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH=/localhome/local-hjc/.npm-global/bin\:/localhome/local-hjc/.vscode-server/cli/servers/Stable-6f17636121051a53c88d3e605c491d22af2ba755/server/bin/remote-cli\:/localhome/local-hjc/.npm-global/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
