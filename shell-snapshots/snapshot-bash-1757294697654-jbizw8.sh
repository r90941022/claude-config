...
export PATH=/localhome/local-hjc/ddm_env/bin\:/localhome/local-hjc/.vscode-server/cli/servers/Stable-6f17636121051a53c88d3e605c491d22af2ba755/server/bin/remote-cli\:/localhome/local-hjc/.npm-global/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
